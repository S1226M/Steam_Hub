                ...
                <div key={video.id} className="table-row">
                  <div className="table-cell video-info">
                    <div className="video-thumb">
                      <img
                        src={`https://picsum.photos/60/40?random=${video.id}`}
                        alt={video.title}
                        onError={(e) => {
                          e.target.src =
                            "https://picsum.photos/60/40?random=999";
                        }}
                      />
                    </div>
                  ...
                  <div className="table-cell">{video.channel}</div>
                  <div className="table-cell">{video.views}</div>
                  <div className="table-cell">{video.likes}K</div>

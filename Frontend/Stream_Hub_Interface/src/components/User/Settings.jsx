      ...
      <div className="settings-section">
        ...
        <div className="setting-item">
          <div className="setting-info">
            ...
            <p>Receive email notifications for new videos and updates</p>
          </div>
      ...
      <div className="settings-section">
        ...
        <div className="setting-item">
          <div className="setting-info">
            ...
            <p>Automatically play videos when navigating to them</p>
          </div>
          <label className="toggle-switch">
            <input
              type="checkbox"
              ...
              onChange={(e) =>
                handleAccountSettingChange("autoPlay", e.target.checked)
              }
            />
            <span className="toggle-slider"></span>
          </label>
        ...
        <div className="setting-item">
          ...
          <select
            value={accountSettings.quality}
            onChange={(e) =>
              handleAccountSettingChange("quality", e.target.value)
            }
